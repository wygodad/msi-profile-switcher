...
public static class Lang
{
    ...
    private static readonly Dictionary<string, string[]> Map = new()
    {
        ...
        ["st_b_cap"]       = new[] { "Power cap", "Limit mocy", "Leistungslimit", "Limite de puissance", "Límite de potencia", "功耗上限", "Limite de potência", "Лимит мощности" },
        ...
        ["st_matrix_note"] = new[] {
            "0x34: in Silent the firmware sets 00 or 01 interchangeably — a highlighted difference here is normal.",
            "0x34: w Silent firmware ustawia zamiennie 00 lub 01 — wyróżniona różnica tutaj jest normalna.",
            "0x34: im Silent setzt die Firmware 00 oder 01 — eine markierte Abweichung ist normal.",
            "0x34 : en Silent, le firmware met 00 ou 01 — une différence ici est normale.",
            "0x34: en Silent el firmware pone 00 o 01 — una diferencia aquí es normal.",
            "0x34：在 Silent 下固件会交替写入 00 或 01，此处高亮差异属正常。",
            "0x34: no Silent o firmware define 00 ou 01 — uma diferença aqui é normal.",
            "0x34: в Silent прошивка ставит 00 или 01 — выделенное отличие здесь нормально." },
        ...
        ["tab_report"]     = new[] { "Report model", "Zgłoś model", "Modell melden", "Signaler", "Reportar modelo", "提交机型", "Reportar modelo", "Сообщить" },
